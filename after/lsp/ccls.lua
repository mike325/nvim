...
---
--- Customization options are passed to ccls at initialization time via init_options,
--- a list of available options can be found
--- [here](https://github.com/MaskRay/ccls/wiki/Customization#initialization-options). For example:
---
--- ```lua
--- vim.lsp.config("ccls", {
---   init_options = {
